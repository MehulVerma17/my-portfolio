    ...
    space-y-6 p-14"
      >
        <h1 className="text-center text-5xl md:text-7xl">
          <span
            className="bg-gradient-to-r from-indigo-500 to-blue-500 bg-clip-text 
      text-transparent"
          >
            Get in Touch
          </span>
        ...
        <p className="text-center text-lg font-semibold text-gray-500">
          ...
          whenever I can. <br /> @ mehulvermaw@gmail.com
        </p>

        <a
          href="mailto:mehulvermaw@gmail.com"
          className="text-nowrap rounded-lg border border-indigo-600 bg-black 
      px-5 py-3 text-lg font-bold text-white shadow-lg shadow-indigo-700 transition-all 
