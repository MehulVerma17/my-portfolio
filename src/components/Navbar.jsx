...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 z-10 flex w-full items-center justify-between border-b border-b-gray-700 bg-black/70 px-16 py-6 text-white backdrop-blur-md md:justify-evenly ">
      ...
      tex-3xl font-semibold transition-all duration-300 hover:opacity-100"
      >
        Mehul Verma
      </a>
      <ul className="hidden md:flex gap-10">
        <a
          href="#home"
          className="cursor-pointer opacity-70 transition-all duration-300
        hover:opacity-100"
        >
          <li>Home</li>
        </a>
      ...
      <ul className="hidden md:flex gap-5">
        ...
        duration-300 hover:text-red-500 hover:opacity-100"
        >
          <BsYoutube />
        </li> */}
        <li
      ...
      {isOpen && (
        <div
          className={`fixed right-0 top-[84px] flex h-screen w-1/2 flex-col
            items-start justify-start gap-10 border-l border-gray-800 bg-black/90 p-12 ${
              isOpen ? "block" : "hidden"
            }`}
        >
